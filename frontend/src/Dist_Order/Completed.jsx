...
import { User, Mail, Phone, Store, Package, DollarSign, MessageCircle, Calendar, AlertCircle, MapPin, Clock } from 'lucide-react';
            ...
            <div key={order._id} className="bg-gray-800 border border-gray-700 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
              <div className="p-3">
                ...
                <div className="space-y-1 text-sm">
                  ...
                  <InfoItem icon={<DollarSign className="text-green-400" />} label="Price" value={`$${order.price}`} />
